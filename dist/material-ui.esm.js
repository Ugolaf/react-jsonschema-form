...
import Box$2 from '@material-ui/core/Box';
...
var MuiComponentContext = /*#__PURE__*/React.createContext(null);

function useMuiComponent() {
  var muiComponents = useContext(MuiComponentContext);
...
var DefaultChildren = function DefaultChildren() {
  if (MaterialUIContext.Box && MaterialUIContext.Button && MaterialUIContext.AddIcon) {
    return /*#__PURE__*/React.createElement(MaterialUIContext.Box, {
      marginTop: 3
    }, /*#__PURE__*/React.createElement(MaterialUIContext.Button, {
      type: "submit",
      variant: "contained",
      color: "primary"
    }, "Submit"));
...
var Mui4FormWrapper = /*#__PURE__*/React.forwardRef(function Mui4TagName(props, ref) {
  ...
  }, /*#__PURE__*/React.createElement(FormTag, Object.assign({
    ref: ref
...
var DefaultChildren$1 = function DefaultChildren() {
  if (Mui5Context.Box && Mui5Context.Button && Mui5Context.AddIcon) {
    return /*#__PURE__*/React.createElement(Mui5Context.Box, {
      marginTop: 3
    }, /*#__PURE__*/React.createElement(Mui5Context.Button, {
      type: "submit",
      variant: "contained",
      color: "primary"
    }, "Submit"));
...
var Mui5FormWrapper = /*#__PURE__*/React.forwardRef(function Mui5TagName(props, ref) {
  var children = props.children,
      _props$as = props.as,
      FormTag = _props$as === void 0 ? 'form' : _props$as,
...
export { ArrayFieldTemplate, FieldTemplate, Fields, MuiComponentContext, MuiForm, MuiForm as MuiForm4, MuiForm5, ObjectFieldTemplate, Theme, Theme as Theme4, Theme5, Widgets };
